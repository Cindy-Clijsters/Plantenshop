$(function() {
   ...
   $advZoekenLink.on('click', function(e) {
    ...
    var oTable = $("#plantenlijst").dataTable({
        "ajax": "services/ajax_json_dt_planten.php",
   ...
   $("#slider-range-hoogte").slider({
    ...
    // Herlaat de tabel na het wijzigen van kleur of soort
    $("#kleur, #soort_id"). on('change', function(){
        herlaadTabel(oTable);
    });
    
});

function herlaadTabel(oTable)
{
